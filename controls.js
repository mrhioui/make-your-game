...
import { warShip, warshipShoot } from "./warshap.js"
import { gameLoop, keys, bullets, scoreNbr,livesNbr } from "./main.js"
...
const restart = () => {
    ...
    bullets.forEach(b => b.htmlElem.remove());
    bullets.length = 0;
